use crate::rays::types::{Line, LineConstructor, Point};
...
impl DxfConverter<Line> for Line {
    ...
    fn to_dxf(self: &Self) -> Entity {
        return Entity::new(EntityType::Line(dxf::entities::Line::new(
            point_to_dxf(&self.a),
            point_to_dxf(&self.b),
        )));
    }
...
mod tests {
    ...
    fn test_line_conversion() {
        let dxf_line = Entity::new(dxf::entities::EntityType::Line(dxf::entities::Line::new(
